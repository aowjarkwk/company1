      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top ">
        ...
        <div class="section2">
          ...
          <tr>
          	...
          	<td><a href="#"  onclick="window.open('qnapw?qna_idx=${dto2.qna_idx}','window_name','width=600,height=500,location=no,status=no,scrollbars=yes');">${dto2.qna_title } </a></td>
          	<td>${dto2.qna_name }</td>
          	<td> <fmt:formatDate value="${dto2.qna_date }" pattern="yyyy.MM.dd"/></td>
