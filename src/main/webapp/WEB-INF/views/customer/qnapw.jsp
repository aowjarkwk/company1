...
function goSubmit() {
    // 부모창의 이름 설정
    document.myForm.target = "famPage"; // 타켓을 부모창으로 설정
    document.myForm.action = "pwConfirm";
...
<body>
    ...
    <li>비밀번호를 글 작성시 입력한 비밀번호를 입력하세요.
        ...
        <div class="section2">
            <form action="pwConfirm" name="myForm">
    ...
    <div class="confirm">
        <input type="image" src="btn_confirm2.gif" value="확인" onclick="goSubmit()">
    </div>
    <div class="close">
