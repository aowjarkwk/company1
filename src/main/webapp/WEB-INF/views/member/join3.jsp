...
<body>
   <div class="wrap">
	...
	%>
        ...
        <div class="section5">
            <div class="table">
            <form action="joinAction" method="post" name="join" onsubmit="return checkValue(); return false; ">
                <table>
                    <tr>
                    ...
                    <tr>
                        <div class="tableinput">
                            <th>이메일</th>
                            <td><input type="eamil" name="member_email" id="member_email"></td>
                        </div>
                    </tr>
                    <tr>
                        <div class="tableinput">
                            <th>이메일 수신여부</th>
                            <td><input type="radio" name="member_email_receive" value="1"><label for="">수신</label> <input type="radio" name="member_email_receive"value="0" id="member_email_receive"><label
                                    for="">수신안함</label></td>
                        </div>
                    </tr>
                    <tr>
                        <div class="tableinput">
                            <th>비밀번호 확인시 질문</th>
                            <td><select id="" name="member_pw_question" id="member_pw_question">
                    ...
                    <tr>
                        <div class="tableinput">
                            <th>비밀번호 확인시 답변</th>
                            <td><input type="text" name="member_pw_answer" id="member_pw_answer"></td>
                        </div>
                    </tr>
                    <tr>
                        <div class="tableinput">
                            <th>성별</th>
                            <td><input type="radio" name="member_gender" value="male" id="member_gender"><label for="">남자</label><input type="radio" name="member_gender" value="female"><label
                                    for="">여자</label></td>
                        </div>
                    </tr>
                    <tr>
