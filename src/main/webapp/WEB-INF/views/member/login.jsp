...
function idFind(){  
    window.open("idFind", "아이디찾기", "width=450, height=500, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
}  
function passwordFind(){  
    window.open("passwordFind", "비밀번호찾기", "width=450, height=500, toolbar=no, menubar=no, scrollbars=no, resizable=yes" );  
}  
...
<body>
	...
	%>
        ...
        <div class=find>
            <div class="idfind">-아이디를 잊으셨나요? <img src="btn_id_find.gif" alt="" onclick="javascript:idFind();"></a></div>
            <div class="passfind">-비밀번호를 잊으셨나요?<img src="btn_pw_find.gif" alt=""onclick="javascript:passwordFind();"></a> </div>
