        ...
        <div class="infoservice">
            <div class="info">
                <div class="infoTitle">
                    <div class="notice">
                        <h5 id="rhdwl">공지사항</h5>
                        <h6 id="ejqhrl"> <a href="community"> 더보기</a></h6>
			...
			<c:forEach var="dto" items="${ list2 }">
                        ...
                        <div class="notice-content">
                            <li><a href="content?notice_idx=${ dto.notice_idx }">${ dto.notice_title }</li>
                            <div class="date"><fmt:formatDate value="${dto.notice_date }" pattern="yyyy.MM.dd"/></div>
                        </div>
