...
public class MyController {
	...
	public String index(Model model) {
		model.addAttribute("list2",comdao.list());
		return "index/index";
	}
	...
	public String content(@RequestParam("notice_idx") int notice_idx ,Model model) {
		comDto result=comdao.content(notice_idx);
	...
	public String pwconfirm(@RequestParam("qna_idx") int qna_idx,
		...
		qnaDto result = qnadao.pwconfirm(qna_idx, qna_pw);
	...
	public String loginAction(@RequestParam("member_id") String member_id,
		...
		loginDto result = logindao.loginAction(member_id, member_pw);
	...
	public String emailCheck(@RequestParam ("member_email") String member_email) {
		...
		loginDto result = logindao.join1(member_email);
	...
	public String idCheck(@RequestParam("member_id") String member_id)  {
		...
		loginDto data = logindao.idCheck(member_id);
	...
	public String idFindAction(@RequestParam("member_name") String member_name,@RequestParam("member_email") String member_email,Model model) {
		
		System.out.println(logindao.idFindAction(member_name, member_email));
		model.addAttribute("dto5",logindao.idFindAction(member_name, member_email));
		if (logindao.idFindAction(member_name, member_email)!=null) {
	...
	public String passwordFindAction(@RequestParam("member_name") String member_name,@RequestParam("member_id") String member_id,@RequestParam("member_email") String member_email,Model model) {
		
		System.out.println(logindao.passwordFindAction(member_name, member_id, member_email));
		model.addAttribute("dto6",logindao.passwordFindAction(member_name, member_id, member_email));
		if (logindao.passwordFindAction(member_name, member_id, member_email)!=null) {
	...
	@RequestMapping("buisness01")
	public String buisness01() {
		return "buisness/buisness01";
	}
